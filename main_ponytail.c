...
/* Thoi gian cho phep doi huong tai goc re (s) -- xem junction_velocity().
   Tang = qua goc nhanh hon nhung sai lech quy dao tai goc lon hon. */
#define JUNCTION_T         0.02f   /* 20ms */
...
/* =============================================================
   ...
   1. junction_velocity (eq 34): khi re goc alpha voi toc do v, vector
      ...
      (Paper dung T = chu ky mau 1ms nhung khi do goc 90 do chi cho phep
       0.35 mm/s, coi nhu dung han. Thuc te cho doi huong trai ra nhieu
       chu ky -> dung JUNCTION_T = 20ms.)
